  ...
  return (
    <div className="min-h-screen relative z-10" style={{ paddingBottom: '4rem' }}>
      <header className="text-center pt-14 pb-8 px-4 fade-in">
        ...
        <h1 className="font-display" style={{ fontSize: '3.5rem', color: '#5a3e3e', fontWeight: 300, lineHeight: 1.1 }}>
          Anılarımız
        </h1>
        <p className="font-body mt-3" style={{ color: '#a07070', fontWeight: 300, fontSize: '1rem', letterSpacing: '0.08em' }}>
        ...
        <button
          ...
          className="font-body gold-shimmer"
          style={{
